	...
	while True:    
		...
		if event.type == pygame.QUIT:
		    ...
		    if event.key == pygame.K_z:
		        print self.straw_man.rect, self.straw_man.x
	    ...
	    self.check_mouse_state()      
            ...
            self.itemGroup.update(self.mouse_state)
