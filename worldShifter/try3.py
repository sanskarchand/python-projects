...
def add_platforms(platG):
    ...
    plat1 = platformC.RotPlatform((200, 50), dirtPath, ORIGIN)
    plat2 = platformC.RotPlatform((275, 50), dirtPath,  ORIGIN)
    plat2_1 = platformC.RotPlatform((350, 50), dirtPath, ORIGIN)
    plat2_2 = platformC.RotPlatform((425, 50), dirtPath, ORIGIN)

    plat2_3 = platformC.RotPlatform((200, 500), dirtPath, ORIGIN)
    plat2_4 = platformC.RotPlatform((275, 310), dirtPath, ORIGIN)
...
def add_extra():
    ...
    rope1 = landscapeC.Rope((275, 170), ropePath)
    rope2 = landscapeC.Rope((275, 240), ropePath)
    g.add(rope2)
...
def main():
    ...
    actionG = pygame.sprite.Group() # dummy
    ...
    while True:
        ...
        for rope in ropeG:
            mainS.blit(rope.image, myCam.use_cam(rope))
